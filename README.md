...
A [Claude Code skill](https://docs.anthropic.com/en/docs/claude-code/skills) that helps AI coding assistants work with i18n strings in projects that use Localhero.ai for translation management.
